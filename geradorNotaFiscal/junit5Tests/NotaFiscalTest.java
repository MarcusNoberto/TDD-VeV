...
class NotaFiscalTest {
	...
	@BeforeEach
	void testNf1() {
		nf1 = new NotaFiscal("Jose", 100.00, 25.00);
		nf2 = new NotaFiscal("Maria", 200.00, 30.00);
		nf3 = new NotaFiscal("Joao", 100.00, 6.00);
	}
	
	@Test
	void testNf2() {
		assertEquals(nf1.toString(), "NotaFiscal: Nome Cliente = Jose, Valor Nota = 100.0, Valor Imposto = 25.0");
	}	
	
	@Test
	void testNomeCliente1() {
		assertEquals(nf1.getNomeCliente(), "Jose");
	}
